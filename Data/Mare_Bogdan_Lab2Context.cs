...
namespace Mare_Bogdan_Lab2.Data
{
    public class Mare_Bogdan_Lab2Context : DbContext
    {
        ...
        public DbSet<Mare_Bogdan_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Mare_Bogdan_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Mare_Bogdan_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
